    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-12">
        <div className="flex items-center mb-6">
          <h2 className="text-2xl font-bold text-white">Öne Çıkan Haber</h2>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden border border-slate-700/50">
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-8">
              ...
              <Link
                to={`/post/${featuredPost.id}`}
                className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-2 rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 font-medium inline-block shadow-lg"
              >
                Tam Haberi Oku
              </Link>
            </div>
      ...
      {/* Recent Posts */}
      <div>
        <h2 className="text-2xl font-bold text-white mb-6">Son Güncellemeler</h2>
